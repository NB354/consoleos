...
# Les scripts appelés directement par Buildroot (post-build/post-image)
# doivent être exécutables. Ce bit est parfois perdu lors d'un push depuis
# Windows ; on le réapplique systématiquement pour éviter tout problème.
